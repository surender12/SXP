...
typedef void(^graphBtnPressed)(NSString *strTitle);

@interface BTSpiderPlotterView : UIView
{
    graphBtnPressed blockFilter;
}
...
@property (nonatomic, assign) int isClickable;
@property (nonatomic, copy) graphBtnPressed blockFilter;
@end
