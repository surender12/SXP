...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        if (![TSMessage iOS7StyleEnabled])
        {
            ...
            UIImage *backgroundImage = [[UIImage imageNamed:@"headerOS6.png"] stretchableImageWithLeftCapWidth:0.0 topCapHeight:0.0];
        ...
        else
        {
            ...
            self.backgroundBlurView.blurTintColor = ColorBackground;
...
//        CGFloat fontSize = [[current valueForKey:@"titleFontSize"] floatValue];
        ...
        if (fontName != nil) {
            [self.titleLabel setFont:FontSemibold(14)];
        } else {
            [self.titleLabel setFont:FontSemibold(14)];
        }
...
//            CGFloat fontSize = [[current valueForKey:@"contentFontSize"] floatValue];
            ...
            if (fontName != nil) {
                [self.contentLabel setFont:FontOpenSans(12)];
            } else {
                [self.contentLabel setFont:FontOpenSans(12)];
            }
